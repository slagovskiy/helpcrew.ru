# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-07 04:19
from __future__ import unicode_literals

from django.db import migrations, models
import helpcrew.userext.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.CharField(default='', max_length=255, verbose_name='UUID')),
                ('email', models.EmailField(db_index=True, max_length=255, unique=True, verbose_name='Email')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=helpcrew.userext.models.User.avatar_path, verbose_name='Avatar')),
